...
public interface IEventRepository
{
    ...
    Task<IEnumerable<CalendarEvent>> GetByDateRangeAsync(DateTime startDate, DateTime endDate, CancellationToken cancellationToken = default);
    Task<IEnumerable<CalendarEvent>> GetUpcomingEventsAsync(Guid userId, int count, CancellationToken cancellationToken = default);
